...
| --- | ---: | --- | --- | --- |
| stable q8 | 131072 | `q8_0` | runtime validated without MTP | Cold 300k-character needle passed; short decode around 79 tok/s. |
| MTP q8 | 102400 | `q8_0` | runtime validated with MTP | Cold 300k-character needle passed; short decode around 69-80 tok/s with `parallel=1`, `b512/ub256`. |
| MTP q8 short-only | 131072 | `q8_0` | short prompts pass, long prefill fails | Short decode around 71-82 tok/s with `b256/ub128`; 300k-character long prompt OOMed during prefill. |
...
- Promote 35B-A3B `102400/q8_0`, `parallel=1`, `b512/ub256`.
